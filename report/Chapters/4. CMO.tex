...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[
        block/.style={rectangle, draw=black!60, very thick, minimum size=9mm},
        1/.style={draw=parula1, very thick},
        2/.style={}
        ]
        % Input layer
        \node (y1) at (0,1.8) [block,draw=parula1] {$C_1x$};
        \node (y2) at (0,0.6) [block,draw=parula2] {$C_2x$};
        \node (y3) at (0,-0.6) [block,draw=parula3] {$C_3x$};
        \node (y4) at (0,-1.8) [block,draw=parula4] {$C_4x$};
        % Observer layer
        \node (xj1) at (3,4.6) [block] {$\hat{x}^J_1$};
        \node (xj2) at (3,3.4) [block] {$\hat{x}^J_2$};
        \node (xj3) at (3,2.2) [block] {$\hat{x}^J_3$};
        \node (xj4) at (3,0.9) [block] {$\hat{x}^J_4$};
        \node (xp1) at (3,-0.9) [block] {$\hat{x}^P_1$};
        \node (xp2) at (3,-2.2) [block] {$\hat{x}^P_2$};
        \node (xp3) at (3,-3.4) [block] {$\hat{x}^P_3$};
        \node (xp4) at (3,-4.6) [block] {$\hat{x}^P_4$};

        % Selection layer
        \node (pi1) at (6,3) [block] {$\pi_1$};
        \node (pi2) at (6,1) [block] {$\pi_2$};
        \node (pi3) at (6,-1) [block] {$\pi_3$};
        \node (pi4) at (6,-3) [block] {$\pi_4$};

        % Final estimate
        \node (sigma) at (9,0) [block] {$\sigma$};

        % lines input -> observer
        \draw[-,draw=black!30] (y1.east) -- (xj1.west);
        \draw[-,draw=black!30] (y2.east) -- (xj1.west);
        \draw[-,draw=black!30] (y3.east) -- (xj1.west);
        
        \draw[-,draw=black!30] (y1.east) -- (xj2.west);
        \draw[-,draw=black!30] (y2.east) -- (xj2.west);
        \draw[-,draw=black!30] (y4.east) -- (xj2.west);

        \draw[-,draw=parula1] (y1.east) -- (xj3.west);
        \draw[-,draw=parula3] (y3.east) -- (xj3.west);
        \draw[-,draw=parula4] (y4.east) -- (xj3.west);

        \draw[-,draw=black!30] (y2.east) -- (xj4.west);
        \draw[-,draw=black!30] (y3.east) -- (xj4.west);
        \draw[-,draw=black!30] (y4.east) -- (xj4.west);

        \draw[-,draw=parula1] (y1.east) -- (xp1.west);

        \draw[-,draw=black!30] (y2.east) -- (xp2.west);

        \draw[-,draw=parula3] (y3.east) -- (xp3.west);

        \draw[-,draw=parula4] (y4.east) -- (xp4.west);

        % lines observer -> selection
        \draw[-,draw=black!30] (xj1.east) -- (pi1.west);
        \draw[-,draw=black!30] (xj2.east) -- (pi2.west);
        \draw[-,draw=black] (xj3.east) -- (pi3.west);
        \draw[-,draw=black!30] (xj4.east) -- (pi4.west);

        \draw[-,draw=black!30] (xp1.east) -- (pi1.west);
        \draw[-,draw=black!30] (xp2.east) -- (pi1.west);
        \draw[-,draw=black!30] (xp3.east) -- (pi1.west);

        \draw[-,draw=black!30] (xp1.east) -- (pi2.west);
        \draw[-,draw=black!30] (xp2.east) -- (pi2.west);
        \draw[-,draw=black!30] (xp4.east) -- (pi2.west);

        \draw[-,draw=black] (xp1.east) -- (pi3.west);
        \draw[-,draw=black] (xp3.east) -- (pi3.west);
        \draw[-,draw=black] (xp4.east) -- (pi3.west);

        \draw[-,draw=black!30] (xp2.east) -- (pi4.west);
        \draw[-,draw=black!30] (xp3.east) -- (pi4.west);
        \draw[-,draw=black!30] (xp4.east) -- (pi4.west);

        \draw[-,draw=black!30] (pi1.east) -- (sigma.west);
        \draw[-,draw=black!30] (pi2.east) -- (sigma.west);
        \draw[-,draw=black] (pi3.east) -- (sigma.west);
        \draw[-,draw=black!30] (pi4.east) -- (sigma.west);
