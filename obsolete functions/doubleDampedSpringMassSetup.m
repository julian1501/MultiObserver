function [system,sysName,A,B,C,D] = doubleDampedSpringMassSetup(mass1,mass2,springConstant1,springConstant2,dampingConstant1,dampingConstant2,J)
    % This function sets up a damped mass spring system.
    sysName = "Double mass-spring-damper";
